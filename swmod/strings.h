...
static std::string MODVERSION = "Version: 1.0.0\n";
...
static std::string enableSeaMonsStr = prefix + "Sea monsters enabled\n";
static std::string disableSeaMonsStr = prefix + "Sea monsters disabled\n";
...
static std::string enableNamePlateStr = prefix + "Name plates enabled\n";
static std::string disableNamePlateStr = prefix + "Name plates disabled\n";
